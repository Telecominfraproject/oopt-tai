    ...
    _Inout_ tai_attribute_t *attr)
{
    ...
    switch (attr->id) {
        ...
        case TAI_MODULE_ATTR_MIN_LASER_FREQ:
        case TAI_MODULE_ATTR_MAX_LASER_FREQ:
        case TAI_MODULE_ATTR_FINE_TUNE_LASER_FREQ:
        case TAI_MODULE_ATTR_LASER_GRID_SUPPORT:
        case TAI_MODULE_ATTR_MAX_LASER_CHANNELS:
